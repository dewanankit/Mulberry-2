start "abra" "python" program_main.py 8801 abra -e 15
ping 127.255.255.255 -n 1 -w 1000
start "bobby" "python" program_main.py -c localhost -p 8801 8802 bobby -e 10
ping 127.255.255.255 -n 1 -w 1000
...
ping 127.255.255.255 -n 1 -w 1000
start "innue" "python" program_main.py -c localhost -p 8801 8809 innue -e 3
ping 127.255.255.255 -n 1 -w 1000
start "judas" "python" program_main.py -c localhost -p 8801 8810 judas -e 3
ping 127.255.255.255 -n 1 -w 1000